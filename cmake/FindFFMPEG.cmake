...
function(_ffmpeg_find component headername)
  find_path(
    ...
    NAMES "lib${component}/${headername}"
    ...
    if(_deps_found)
      if(NOT TARGET "FFMPEG::${component}")
        ...
        set_target_properties(
          "FFMPEG::${component}"
          PROPERTIES IMPORTED_LOCATION "${FFMPEG_${component}_LIBRARY}"
      ...
      if(EXISTS "${version_header_path}")
        ...
        if(NOT major STREQUAL ""
           AND NOT minor STREQUAL ""
           AND NOT micro STREQUAL "")
...
if(TARGET FFMPEG::avutil)
  set(_ffmpeg_version_header_path
