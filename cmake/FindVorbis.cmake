# * Find vorbis
#
# Provides Vorbis config targets: - Vorbis::vorbis - Vorbis::vorbisenc
#
# Find the native vorbis and  vorbisenc includes and libraries
#
# VORBIS_INCLUDE_DIRS - where to find vorbis.h, etc. VORBIS_LIBRARIES    - List
# of libraries when using vorbis. VORBIS_FOUND        - True if vorbis found.
#
# VORBISENC_INCLUDE_DIRS - where to find vorbisenc.h, etc. VORBISENC_LIBRARIES -
# List of libraries when using vorbisenc. VORBISENC_FOUND        - True if
# vorbisenc found.
...
if(NOT TARGET Vorbis::vorbis OR NOT TARGET Vorbis::vorbisenc)
  ...
  find_path(VORBISENC_INCLUDE_DIR vorbis/vorbisenc.h
            HINTS ${PC_VORBISENC_INCLUDEDIR} ${PC_VORBISENC_INCLUDE_DIRS}
                  ${VORBISENC_ROOT})

  find_library(
    VORBISENC_LIBRARY
    NAMES vorbisenc vorbisenc_static libvorbisenc libvorbisenc_static
    HINTS ${PC_VORBISENC_LIBDIR} ${PC_VORBISENC_LIBRARY_DIRS} ${VORBISENC_ROOT})

  # Handle the QUIETLY and REQUIRED arguments and set VORBISENC_FOUND to TRUE if
  # all listed variables are TRUE.
  include(FindPackageHandleStandardArgs)
  set(FPHSA_NAME_MISMATCHED TRUE)
  find_package_handle_standard_args(
    VorbisEnc
    REQUIRED_VARS VORBISENC_LIBRARY VORBISENC_INCLUDE_DIR VORBIS_FOUND
    VERSION_VAR VORBISENC_VERSION)
  ...
  if(VORBISENC_FOUND)
    ...
    if(NOT TARGET Vorbis::vorbisenc)
      ...
      set_target_properties(
        Vorbis::vorbisenc
        PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${VORBISENC_INCLUDE_DIR}"
